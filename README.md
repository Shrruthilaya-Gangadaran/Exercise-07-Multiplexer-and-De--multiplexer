...
MULTIPLEXER:
```
module shru(I0,I1,I2,I3,S0,S1,Y);
...
```
### RTL LOGIC VIEWER
![](multiplexerlogicgate.PNG)
### TIMING DIGRAM 
![](multiplexertimingdiagram.PNG)
### TRUTH TABLE 
...
```
### RTL LOGIC VIEWER
![](demultiplexerlogicgate.PNG)
### TIMING DIGRAM 
![](demultiplexertimingdiagram.PNG)
### TRUTH TABLE 
![](demultiplexertruthtable.png)
### RESULTS 
